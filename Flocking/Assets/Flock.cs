...
public class Flock : MonoBehaviour {
    ...
    private void Movement()
    {
        ...
        if (Vector3.Distance(this.gameObject.transform.position, myManager.marginado.allFish[0].transform.position) < myManager.distanceWithMarginado)
        {
            turning = true;
            direction = transform.position - myManager.marginado.allFish[0].transform.position;
        }
